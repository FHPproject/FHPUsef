 ...
 * @author 104903
 * @version 1.0
 * @created 20-oct-2017 12:03:08
 */
@Entity
@Table(name = "IMBALANCE_PRICE_SURPLUS_FORECAST_PTU")
public class ImbalancePriceSurplusForecastPtu {
    @Id
...
//	public FLOAT PRICE;
	...
	public ImbalancePriceSurplusForecastPtu(){
    ...
    public Long getNumberPtus() {
        return numberPtus;
    }

    public void setNumberPtus(Long numberPtus) {
