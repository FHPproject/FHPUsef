 ...
 * @author 104903
 * @version 1.0
 * @created 20-oct-2017 12:03:25
 */
@Entity
@Table(name = "PORTFOLIO_ENERGY_FORECAST_PTU")
public class PortfolioEnergyForecastPtu {
    @Id
    @GeneratedValue(strategy = GenerationType.AUTO)
    @Column(name = "ID", nullable = false)
    private Long id;
//	public BIGINT ID;
    @Column(name = "PORTFOLIO_ENERGY_FORECAST_ID", nullable = false)
    private Long portfolioEnergyForecastId;
//	public BIGINT PORTFOLIO_ENERGY_FORECAST_ID;
	/**
...
//	public FLOAT ACTIVE_POWER;
    ...
    public Long getPortfolioEnergyForecastId() {
        return portfolioEnergyForecastId;
    }

    public void setPortfolioEnergyForecastId(Long portfolioEnergyForecastId) {
        this.portfolioEnergyForecastId = portfolioEnergyForecastId;
    }
    ...
    public PortfolioEnergyForecastPtu(){
    }
