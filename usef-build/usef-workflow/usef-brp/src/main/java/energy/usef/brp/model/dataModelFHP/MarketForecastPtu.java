 ...
 */
@Entity
@Table(name = "MARKET_FORECAST_PTU")
public class MarketForecastPtu {         
    @Id
    @GeneratedValue(strategy = GenerationType.AUTO)
    @Column(name = "ID", nullable = false)
    private Long id;
//	public BIGINT ID;
    @Column(name = "MARKET_FORECAST_ID", nullable = false)
    private Long marketForecastId;
	/**
    ...
    public Long getMarketForecastId() {
        return marketForecastId;
    }

    public void setMarketForecastId(Long marketForecastId) {
        this.marketForecastId = marketForecastId;
    }
