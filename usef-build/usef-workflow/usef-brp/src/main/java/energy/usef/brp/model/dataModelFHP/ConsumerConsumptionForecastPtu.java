 ...
 */
@Entity
@Table(name = "CONSUMER_CONSUMPTION_FORECAST_PTU")
public class ConsumerConsumptionForecastPtu {   
    @Id
    @GeneratedValue(strategy = GenerationType.AUTO)
    @Column(name = "ID", nullable = false)
    private Long id;
//	public BIGINT ID;
    @Column(name = "CONSUMER_CONSUMPTION_FORECAST_ID", nullable = false)
    private Long consumerConsumptionForecastId;
...
//	public FLOAT ACTIVE_POWER;
    ...
    public ConsumerConsumptionForecastPtu(){
	}

    public void finalize() throws Throwable {
	}

    public Long getConsumerConsumptionForecastId() {
        return consumerConsumptionForecastId;
    }

    public void setConsumerConsumptionForecastId(Long consumerConsumptionForecastId) {
        this.consumerConsumptionForecastId = consumerConsumptionForecastId;
    }
