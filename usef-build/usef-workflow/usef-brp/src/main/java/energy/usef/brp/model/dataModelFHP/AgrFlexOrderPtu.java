 ...
 */
@Entity
@Table(name = "AGR_FLEX_ORDER_PTU")
public class AgrFlexOrderPtu {   
    @Id
    @GeneratedValue(strategy = GenerationType.AUTO)
    @Column(name = "ID", nullable = false)
    private Long id;
//	public BIGINT ID;
    @Column(name = "AGR_FLEX_ORDER_ID", nullable = false)
    private Long agrFlexOrderId;
...
//	public FLOAT PRICE;
    ...
    public Long getAgrFlexOrderId() {
        return agrFlexOrderId;
    }

    public void setAgrFlexOrderId(Long agrFlexOrderId) {
        this.agrFlexOrderId = agrFlexOrderId;
    }
