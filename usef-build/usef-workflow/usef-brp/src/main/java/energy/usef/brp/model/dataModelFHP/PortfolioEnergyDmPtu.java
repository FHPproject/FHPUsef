 ...
 */
@Entity
@Table(name = "PORTFOLIO_ENERGY_DM_PTU")
public class PortfolioEnergyDmPtu {         
    @Id
    @GeneratedValue(strategy = GenerationType.AUTO)
    @Column(name = "ID", nullable = false)
    private Long id;
//	public BIGINT ID;
    @Column(name = "PORTFOLIO_ENERGY_DM_ID", nullable = false)
    private Long portfolioEnergyDmId;
//	public BIGINT PORTFOLIO_ENERGY_DM_ID;
	/**
    ...
    public Long getPortfolioEnergyDmId() {
        return portfolioEnergyDmId;
    }

    public void setPortfolioEnergyDmId(Long portfolioEnergyDmId) {
        this.portfolioEnergyDmId = portfolioEnergyDmId;
    }
